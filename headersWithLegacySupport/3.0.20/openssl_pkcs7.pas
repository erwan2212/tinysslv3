    ...
    * out the 'type' field.
    ...
    d: record 
      case integer of 
        ...
        2: (sign: PPKCS7_SIGNED); { NID_pkcs7_enveloped }
...
const
  ...
  {# define  PKCS7_get_signed_attributes(si) ((si)->auth_attr)} {Macro Return Type unknown at line no 257}
  {# define  PKCS7_get_attributes(si) ((si)->unauth_attr)} {Macro Return Type unknown at line no 258}
  {# define  PKCS7_type_is_signed(a) (OBJ_obj2nid((a)->type) == NID_pkcs7_signed)} {Macro Return Type unknown at line no 260}
  {# define  PKCS7_type_is_encrypted(a) (OBJ_obj2nid((a)->type) == NID_pkcs7_encrypted)} {Macro Return Type unknown at line no 261}
  {# define  PKCS7_type_is_enveloped(a) (OBJ_obj2nid((a)->type) == NID_pkcs7_enveloped)} {Macro Return Type unknown at line no 262}
  {# define  PKCS7_type_is_signedAndEnveloped(a) (OBJ_obj2nid((a)->type) == NID_pkcs7_signedAndEnveloped)} {Macro Return Type unknown at line no 263}
  {# define  PKCS7_type_is_data(a) (OBJ_obj2nid((a)->type) == NID_pkcs7_data)} {Macro Return Type unknown at line no 265}
  {# define  PKCS7_type_is_digest(a) (OBJ_obj2nid((a)->type) == NID_pkcs7_digest)} {Macro Return Type unknown at line no 266}
...
var
  ...
  function PKCS7_add_certificate(p7: PPKCS7; x509: PX509): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'PKCS7_add_certificate';
  function PKCS7_add_crl(p7: PPKCS7; x509: PX509_CRL): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'PKCS7_add_crl';
  ...
  function PKCS7_signatureVerify(bio: PBIO; p7: PPKCS7; si: PPKCS7_SIGNER_INFO; x509: PX509): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'PKCS7_signatureVerify';
