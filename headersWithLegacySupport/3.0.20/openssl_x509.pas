...
{
  Generated from OpenSSL 3.0.20 Header File x509.h - Tue 19 May 14:26:00 BST 2026
...
var
  ...
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
  {$ifndef  OPENSSL_NO_DEPRECATED_3_0}
{# define  X509_http_nbio(rctx,pcert) OSSL_HTTP_REQ_CTX_nbio_d2i(rctx, pcert, ASN1_ITEM_rptr(X509))} {Macro Return Type unknown at line no 556}
{# define  X509_CRL_http_nbio(rctx,pcrl) OSSL_HTTP_REQ_CTX_nbio_d2i(rctx, pcrl, ASN1_ITEM_rptr(X509_CRL))} {Macro Return Type unknown at line no 558}
...
var
  ...
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
  {# define  X509_get_ex_new_index(l,p,newf,dupf,freef) CRYPTO_get_ex_new_index(CRYPTO_EX_INDEX_X509, l, p, newf, dupf, freef)} {Macro Return Type unknown at line no 750}
...
var
  ...
  function X509_REQ_check_private_key(x509: PX509_REQ; pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_REQ_check_private_key';
  function X509_check_private_key(x509: PX509; pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_check_private_key';
  ...
  function Load_X509_check_private_key(x509: PX509; pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl;
...
var
  ...
  X509_check_private_key: function(x509: PX509; pkey: PEVP_PKEY): TOpenSSL_C_INT; cdecl = Load_X509_check_private_key;
