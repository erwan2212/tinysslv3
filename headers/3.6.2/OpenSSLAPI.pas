...
const
  ...
  PTHREAD_ONCE_INIT = 0; {no thread library}
...
{$ENDIF}  //FPC
  ...
  FILE_ = THandle; {Unix file handle}
  PFILE = ^FILE_;
  {copied from netdb.h}
  Phostent = ^Thostent;
  Thostent = record
    ...
    h_addrtype : POpenSSL_C_INT;		{ host address type }
    h_length : POpenSSL_C_INT;		{ length of address }
