...
begin
  ...
  if not assigned(OSSL_PARAM_set_octet_string_or_ptr) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('OSSL_PARAM_set_octet_string_or_ptr');
  Result := OSSL_PARAM_set_octet_string_or_ptr(p, val, len);
end;
