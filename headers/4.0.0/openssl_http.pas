...
{
  Generated from OpenSSL 4.0.0 Header File http.h - Tue 19 May 14:32:45 BST 2026
}
...
const
  ...
  procedure OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines(rctx: POSSL_HTTP_REQ_CTX; count: TOpenSSL_C_SIZET); cdecl; external CLibCrypto name 'OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines';
  ...
  procedure Load_OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines(rctx: POSSL_HTTP_REQ_CTX; count: TOpenSSL_C_SIZET); cdecl;
...
var
  ...
  OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines: procedure(rctx: POSSL_HTTP_REQ_CTX; count: TOpenSSL_C_SIZET); cdecl = Load_OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines;
...
procedure Load_OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines(rctx: POSSL_HTTP_REQ_CTX; count: TOpenSSL_C_SIZET); cdecl;
begin
  OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines := LoadLibCryptoFunction('OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines');
  if not assigned(OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines');
  OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines(rctx, count);
end;
...
{$ifndef  OPENSSL_NO_HTTP}
  ...
  OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines := Load_OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines;
