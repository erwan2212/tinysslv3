...
{
  Generated from OpenSSL 4.0.0 Header File sslerr.h - Tue 19 May 14:33:20 BST 2026
}

{$IFNDEF FPC}
{$IFDEF OPENSSL_USE_STATIC_LIBRARY}
{$LINK openssl_sslerr.obj}
{$ENDIF}
{$ENDIF}

interface

uses OpenSSLAPI,openssl_symhacks,openssl_sslerr_legacy;
...
const
  ...
  SSL_R_BAD_CERTIFICATE = 348;
  SSL_R_BAD_CHANGE_CIPHER_SPEC = 103;
  SSL_R_BAD_CIPHER = 186;
  SSL_R_BAD_COMPRESSION_ALGORITHM = 326;
  SSL_R_BAD_DATA = 390;
  ...
  SSL_R_BAD_ECHCONFIG_EXTENSION = 425;
  ...
  SSL_R_FAILED_TO_GET_PARAMETER = 316;
  SSL_R_FAILED_TO_INIT_ASYNC = 405;
  SSL_R_FEATURE_NEGOTIATION_NOT_COMPLETE = 417;
  SSL_R_FEATURE_NOT_RENEGOTIABLE = 413;
  ...
  SSL_R_INVALID_RAW_PUBLIC_KEY = 350;
  SSL_R_INVALID_RECORD = 317;
  ...
  SSL_R_LISTENER_USE_ONLY = 421;
  SSL_R_MAXIMUM_ENCRYPTED_PKTS_REACHED = 395;
  ...
  SSL_R_MISSING_QUIC_TLS_FUNCTIONS = 423;
  ...
  SSL_R_NO_SUITABLE_RECORD_LAYER = 322;
  ...
  SSL_R_POLL_REQUEST_NOT_SUPPORTED = 418;
  ...
  SSL_R_QUIC_HANDSHAKE_LAYER_ERROR = 393;
  SSL_R_QUIC_NETWORK_ERROR = 387;
  SSL_R_QUIC_PROTOCOL_ERROR = 382;
  SSL_R_READ_BIO_NOT_SET = 211;
  SSL_R_READ_TIMEOUT_EXPIRED = 312;
  SSL_R_RECORDS_NOT_RELEASED = 321;
  SSL_R_RECORD_LAYER_FAILURE = 313;
  SSL_R_RECORD_LENGTH_MISMATCH = 213;
  SSL_R_RECORD_TOO_SMALL = 298;
  SSL_R_REMOTE_PEER_ADDRESS_NOT_SET = 346;
  ...
  SSL_R_SEQUENCE_CTR_WRAPPED = 327;
  ...
  SSL_R_TLS_EXT_INVALID_SERVERNAME = 319;
  SSL_R_TLS_EXT_INVALID_SERVERNAME_TYPE = 320;
  SSL_R_TLS_SESSION_ID_TOO_LONG = 300;
  SSL_R_TLS_ALERT_BAD_CERTIFICATE = 1042;
  SSL_R_TLS_ALERT_BAD_RECORD_MAC = 1020;
  SSL_R_TLS_ALERT_CERTIFICATE_EXPIRED = 1045;
  SSL_R_TLS_ALERT_CERTIFICATE_REVOKED = 1044;
  SSL_R_TLS_ALERT_CERTIFICATE_UNKNOWN = 1046;
  SSL_R_TLS_ALERT_DECOMPRESSION_FAILURE = 1030;
  SSL_R_TLS_ALERT_HANDSHAKE_FAILURE = 1040;
  SSL_R_TLS_ALERT_ILLEGAL_PARAMETER = 1047;
  SSL_R_TLS_ALERT_NO_CERTIFICATE = 1041;
  SSL_R_TLS_ALERT_UNEXPECTED_MESSAGE = 1010;
  ...
  SSL_R_STREAM_COUNT_LIMITED = 411;
  SSL_R_STREAM_FINISHED = 365;
  SSL_R_STREAM_RECV_ONLY = 366;
  SSL_R_STREAM_RESET = 375;
  SSL_R_STREAM_SEND_ONLY = 379;
  ...
  SSL_R_UNKNOWN_MANDATORY_PARAMETER = 323;
  ...
  SSL_R_UNSUPPORTED_CONFIG_VALUE = 414;
  SSL_R_UNSUPPORTED_CONFIG_VALUE_CLASS = 415;
  SSL_R_UNSUPPORTED_CONFIG_VALUE_OP = 416;
  ...
  SSL_R_UNSUPPORTED_WRITE_FLAG = 412;
