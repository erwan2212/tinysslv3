...
{
  Generated from OpenSSL 4.0.0 Header File cms.h - Tue 19 May 14:32:07 BST 2026
}
...
uses OpenSSLAPI,openssl_types,openssl_stack,openssl_asn1,openssl_e_os2,
     openssl_x509,openssl_x509v3,openssl_cmserr;
...
type
  ...
  PCMS_EnvelopedData_st = ^TCMS_EnvelopedData;
  PPCMS_EnvelopedData_st = ^PCMS_EnvelopedData_st;
  PCMS_EnvelopedData = ^TCMS_EnvelopedData;
  PPCMS_EnvelopedData = ^PCMS_EnvelopedData;
  ...
  PCMS_SignedData_st = ^TCMS_SignedData;
  PPCMS_SignedData_st = ^PCMS_SignedData_st;
  PCMS_SignedData = ^TCMS_SignedData;
  PPCMS_SignedData = ^PCMS_SignedData;
...
type
  ...
  function sk_CMS_SignerInfo_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
  ...
  {# define  sk_CMS_SignerInfo_num(sk) OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sk))} {Macro Return Type unknown at line no 50}
  {# define  sk_CMS_SignerInfo_value(sk,idx) ((CMS_SignerInfo *)OPENSSL_sk_value(ossl_check_const_CMS_SignerInfo_sk_type(sk), (idx)))} {Function argument out of range at line no 51}
  {# define  sk_CMS_SignerInfo_new(cmp) ((STACK_OF(CMS_SignerInfo) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new(ossl_check_CMS_SignerInfo_compfunc_type(cmp)),
 sk_CMS_SignerInfo_cmpfunc_thunk))}
  ...
  {# define  sk_CMS_SignerInfo_new_reserve(cmp,n) ((STACK_OF(CMS_SignerInfo) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new_reserve(ossl_check_CMS_SignerInfo_compfunc_type(cmp),
 (n)), sk_CMS_SignerInfo_cmpfunc_thunk))}
  {# define  sk_CMS_SignerInfo_reserve(sk,n) OPENSSL_sk_reserve(ossl_check_CMS_SignerInfo_sk_type(sk), (n))} {Function argument out of range at line no 55}
  {# define  sk_CMS_SignerInfo_free(sk) OPENSSL_sk_free(ossl_check_CMS_SignerInfo_sk_type(sk))} {Macro Return Type unknown at line no 56}
  {# define  sk_CMS_SignerInfo_zero(sk) OPENSSL_sk_zero(ossl_check_CMS_SignerInfo_sk_type(sk))} {Macro Return Type unknown at line no 57}
  {# define  sk_CMS_SignerInfo_delete(sk,i) ((CMS_SignerInfo *)OPENSSL_sk_delete(ossl_check_CMS_SignerInfo_sk_type(sk), (i)))} {Function argument out of range at line no 58}
  function sk_CMS_SignerInfo_delete_ptr(sk:Pstack_st_CMS_SignerInfo; ptr:PCMS_SignerInfo): PCMS_SignerInfo; inline;
  {# define  sk_CMS_SignerInfo_push(sk,ptr) OPENSSL_sk_push(ossl_check_CMS_SignerInfo_sk_type(sk), ossl_check_CMS_SignerInfo_type(ptr))} {Macro Return Type unknown at line no 60}
 ...
 (idx))} {Function argument out of range at line no 65}
  ...
  {# define  sk_CMS_SignerInfo_find(sk,ptr) OPENSSL_sk_find(ossl_check_CMS_SignerInfo_sk_type(sk), ossl_check_CMS_SignerInfo_type(ptr))} {Macro Return Type unknown at line no 67}
  {# define  sk_CMS_SignerInfo_find_ex(sk,ptr) OPENSSL_sk_find_ex(ossl_check_CMS_SignerInfo_sk_type(sk), ossl_check_CMS_SignerInfo_type(ptr))} {Macro Return Type unknown at line no 68}
 ...
 pnum)} {Function argument out of range at line no 69}
  {# define  sk_CMS_SignerInfo_sort(sk) OPENSSL_sk_sort(ossl_check_CMS_SignerInfo_sk_type(sk))} {Macro Return Type unknown at line no 70}
  {# define  sk_CMS_SignerInfo_is_sorted(sk) OPENSSL_sk_is_sorted(ossl_check_const_CMS_SignerInfo_sk_type(sk))} {Macro Return Type unknown at line no 71}
...
type
  ...
  function sk_CMS_RecipientEncryptedKey_cmpfunc_thunk(cmp: TFuncType001; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
  ...
  {# define  sk_CMS_RecipientEncryptedKey_num(sk) OPENSSL_sk_num(ossl_check_const_CMS_RecipientEncryptedKey_sk_type(sk))} {Macro Return Type unknown at line no 76}
 ...
 (idx)))} {Function argument out of range at line no 77}
  {# define  sk_CMS_RecipientEncryptedKey_new(cmp) ((STACK_OF(CMS_RecipientEncryptedKey) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new(ossl_check_CMS_RecipientEncryptedKey_compfunc_type(cmp)),
 sk_CMS_RecipientEncryptedKey_cmpfunc_thunk))}
  {# define  sk_CMS_RecipientEncryptedKey_new_null() ((STACK_OF(CMS_RecipientEncryptedKey) *)OPENSSL_sk_set_thunks(OPENSSL_sk_new_null(),
 sk_CMS_RecipientEncryptedKey_freefunc_thunk))}
  {# define  sk_CMS_RecipientEncryptedKey_new_reserve(cmp,n) ((STACK_OF(CMS_RecipientEncryptedKey) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new_reserve(ossl_check_CMS_RecipientEncryptedKey_compfunc_type(cmp),
 (n)), sk_CMS_RecipientEncryptedKey_cmpfunc_thunk))}
  {# define  sk_CMS_RecipientEncryptedKey_reserve(sk,n) OPENSSL_sk_reserve(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk), (n))} {Function argument out of range at line no 81}
  {# define  sk_CMS_RecipientEncryptedKey_free(sk) OPENSSL_sk_free(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk))} {Macro Return Type unknown at line no 82}
  {# define  sk_CMS_RecipientEncryptedKey_zero(sk) OPENSSL_sk_zero(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk))} {Macro Return Type unknown at line no 83}
 ...
 (i)))} {Function argument out of range at line no 84}
  ...
  {# define  sk_CMS_RecipientEncryptedKey_push(sk,ptr) OPENSSL_sk_push(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk), ossl_check_CMS_RecipientEncryptedKey_type(ptr))} {Macro Return Type unknown at line no 86}
  {# define  sk_CMS_RecipientEncryptedKey_unshift(sk,ptr) OPENSSL_sk_unshift(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk), ossl_check_CMS_RecipientEncryptedKey_type(ptr))} {Macro Return Type unknown at line no 87}
 ...
 (idx), ossl_check_CMS_RecipientEncryptedKey_type(ptr)))} {Function argument out of range at line no 92}
  {# define  sk_CMS_RecipientEncryptedKey_find(sk,ptr) OPENSSL_sk_find(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk), ossl_check_CMS_RecipientEncryptedKey_type(ptr))} {Macro Return Type unknown at line no 93}
  {# define  sk_CMS_RecipientEncryptedKey_find_ex(sk,ptr) OPENSSL_sk_find_ex(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk), ossl_check_CMS_RecipientEncryptedKey_type(ptr))} {Macro Return Type unknown at line no 94}
 ...
 ossl_check_CMS_RecipientEncryptedKey_type(ptr), pnum)} {Function argument out of range at line no 95}
  {# define  sk_CMS_RecipientEncryptedKey_sort(sk) OPENSSL_sk_sort(ossl_check_CMS_RecipientEncryptedKey_sk_type(sk))} {Macro Return Type unknown at line no 96}
  {# define  sk_CMS_RecipientEncryptedKey_is_sorted(sk) OPENSSL_sk_is_sorted(ossl_check_const_CMS_RecipientEncryptedKey_sk_type(sk))} {Macro Return Type unknown at line no 97}
...
type
  ...
  function sk_CMS_RecipientInfo_cmpfunc_thunk(cmp: TFuncType002; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
  ...
  {# define  sk_CMS_RecipientInfo_num(sk) OPENSSL_sk_num(ossl_check_const_CMS_RecipientInfo_sk_type(sk))} {Macro Return Type unknown at line no 102}
 ...
 (idx)))} {Function argument out of range at line no 103}
  {# define  sk_CMS_RecipientInfo_new(cmp) ((STACK_OF(CMS_RecipientInfo) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new(ossl_check_CMS_RecipientInfo_compfunc_type(cmp)),
 sk_CMS_RecipientInfo_cmpfunc_thunk))}
  ...
  {# define  sk_CMS_RecipientInfo_new_reserve(cmp,n) ((STACK_OF(CMS_RecipientInfo) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new_reserve(ossl_check_CMS_RecipientInfo_compfunc_type(cmp),
 (n)), sk_CMS_RecipientInfo_cmpfunc_thunk))}
  {# define  sk_CMS_RecipientInfo_reserve(sk,n) OPENSSL_sk_reserve(ossl_check_CMS_RecipientInfo_sk_type(sk), (n))} {Function argument out of range at line no 107}
  {# define  sk_CMS_RecipientInfo_free(sk) OPENSSL_sk_free(ossl_check_CMS_RecipientInfo_sk_type(sk))} {Macro Return Type unknown at line no 108}
  {# define  sk_CMS_RecipientInfo_zero(sk) OPENSSL_sk_zero(ossl_check_CMS_RecipientInfo_sk_type(sk))} {Macro Return Type unknown at line no 109}
  {# define  sk_CMS_RecipientInfo_delete(sk,i) ((CMS_RecipientInfo *)OPENSSL_sk_delete(ossl_check_CMS_RecipientInfo_sk_type(sk), (i)))} {Function argument out of range at line no 110}
  function sk_CMS_RecipientInfo_delete_ptr(sk:Pstack_st_CMS_RecipientInfo; ptr:PCMS_RecipientInfo): PCMS_RecipientInfo; inline;
  {# define  sk_CMS_RecipientInfo_push(sk,ptr) OPENSSL_sk_push(ossl_check_CMS_RecipientInfo_sk_type(sk), ossl_check_CMS_RecipientInfo_type(ptr))} {Macro Return Type unknown at line no 112}
 ...
 ossl_check_CMS_RecipientInfo_type(ptr)))} {Function argument out of range at line no 118}
  {# define  sk_CMS_RecipientInfo_find(sk,ptr) OPENSSL_sk_find(ossl_check_CMS_RecipientInfo_sk_type(sk), ossl_check_CMS_RecipientInfo_type(ptr))} {Macro Return Type unknown at line no 119}
  {# define  sk_CMS_RecipientInfo_find_ex(sk,ptr) OPENSSL_sk_find_ex(ossl_check_CMS_RecipientInfo_sk_type(sk), ossl_check_CMS_RecipientInfo_type(ptr))} {Macro Return Type unknown at line no 120}
 ...
 pnum)} {Function argument out of range at line no 121}
  {# define  sk_CMS_RecipientInfo_sort(sk) OPENSSL_sk_sort(ossl_check_CMS_RecipientInfo_sk_type(sk))} {Macro Return Type unknown at line no 122}
  {# define  sk_CMS_RecipientInfo_is_sorted(sk) OPENSSL_sk_is_sorted(ossl_check_const_CMS_RecipientInfo_sk_type(sk))} {Macro Return Type unknown at line no 123}
...
type
  ...
  function sk_CMS_RevocationInfoChoice_cmpfunc_thunk(cmp: TFuncType003; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
  ...
  {# define  sk_CMS_RevocationInfoChoice_num(sk) OPENSSL_sk_num(ossl_check_const_CMS_RevocationInfoChoice_sk_type(sk))} {Macro Return Type unknown at line no 128}
 ...
 (idx)))} {Function argument out of range at line no 129}
  {# define  sk_CMS_RevocationInfoChoice_new(cmp) ((STACK_OF(CMS_RevocationInfoChoice) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new(ossl_check_CMS_RevocationInfoChoice_compfunc_type(cmp)),
 sk_CMS_RevocationInfoChoice_cmpfunc_thunk))}
  {# define  sk_CMS_RevocationInfoChoice_new_null() ((STACK_OF(CMS_RevocationInfoChoice) *)OPENSSL_sk_set_thunks(OPENSSL_sk_new_null(),
 sk_CMS_RevocationInfoChoice_freefunc_thunk))}
  {# define  sk_CMS_RevocationInfoChoice_new_reserve(cmp,n) ((STACK_OF(CMS_RevocationInfoChoice) *)OPENSSL_sk_set_cmp_thunks(OPENSSL_sk_new_reserve(ossl_check_CMS_RevocationInfoChoice_compfunc_type(cmp),
 (n)), sk_CMS_RevocationInfoChoice_cmpfunc_thunk))}
  {# define  sk_CMS_RevocationInfoChoice_reserve(sk,n) OPENSSL_sk_reserve(ossl_check_CMS_RevocationInfoChoice_sk_type(sk), (n))} {Function argument out of range at line no 133}
  {# define  sk_CMS_RevocationInfoChoice_free(sk) OPENSSL_sk_free(ossl_check_CMS_RevocationInfoChoice_sk_type(sk))} {Macro Return Type unknown at line no 134}
  {# define  sk_CMS_RevocationInfoChoice_zero(sk) OPENSSL_sk_zero(ossl_check_CMS_RevocationInfoChoice_sk_type(sk))} {Macro Return Type unknown at line no 135}
 ...
 (i)))} {Function argument out of range at line no 136}
  ...
  {# define  sk_CMS_RevocationInfoChoice_push(sk,ptr) OPENSSL_sk_push(ossl_check_CMS_RevocationInfoChoice_sk_type(sk), ossl_check_CMS_RevocationInfoChoice_type(ptr))} {Macro Return Type unknown at line no 138}
  {# define  sk_CMS_RevocationInfoChoice_unshift(sk,ptr) OPENSSL_sk_unshift(ossl_check_CMS_RevocationInfoChoice_sk_type(sk), ossl_check_CMS_RevocationInfoChoice_type(ptr))} {Macro Return Type unknown at line no 139}
 ...
 (idx), ossl_check_CMS_RevocationInfoChoice_type(ptr)))} {Function argument out of range at line no 144}
  {# define  sk_CMS_RevocationInfoChoice_find(sk,ptr) OPENSSL_sk_find(ossl_check_CMS_RevocationInfoChoice_sk_type(sk), ossl_check_CMS_RevocationInfoChoice_type(ptr))} {Macro Return Type unknown at line no 145}
  {# define  sk_CMS_RevocationInfoChoice_find_ex(sk,ptr) OPENSSL_sk_find_ex(ossl_check_CMS_RevocationInfoChoice_sk_type(sk), ossl_check_CMS_RevocationInfoChoice_type(ptr))} {Macro Return Type unknown at line no 146}
 ...
 ossl_check_CMS_RevocationInfoChoice_type(ptr), pnum)} {Function argument out of range at line no 147}
  {# define  sk_CMS_RevocationInfoChoice_sort(sk) OPENSSL_sk_sort(ossl_check_CMS_RevocationInfoChoice_sk_type(sk))} {Macro Return Type unknown at line no 148}
  {# define  sk_CMS_RevocationInfoChoice_is_sorted(sk) OPENSSL_sk_is_sorted(ossl_check_const_CMS_RevocationInfoChoice_sk_type(sk))} {Macro Return Type unknown at line no 149}
 ...
 ossl_check_CMS_RevocationInfoChoice_copyfunc_type(copyfunc), ossl_check_CMS_RevocationInfoChoice_freefunc_type(freefunc)))}
  ...
  function Load_CMS_EnvelopedData_it: PASN1_ITEM; cdecl;
  function Load_CMS_SignedData_new: PCMS_SignedData; cdecl;
  procedure Load_CMS_SignedData_free(a: PCMS_SignedData); cdecl;
  ...
  function Load_CMS_EnvelopedData_dup(a: PCMS_EnvelopedData): PCMS_EnvelopedData; cdecl;
  function Load_CMS_ContentInfo_new_ex(libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;

var
  CMS_EnvelopedData_it: function: PASN1_ITEM; cdecl = Load_CMS_EnvelopedData_it;
  CMS_SignedData_new: function: PCMS_SignedData; cdecl = Load_CMS_SignedData_new;
  CMS_SignedData_free: procedure(a: PCMS_SignedData); cdecl = Load_CMS_SignedData_free;
  ...
  CMS_EnvelopedData_dup: function(a: PCMS_EnvelopedData): PCMS_EnvelopedData; cdecl = Load_CMS_EnvelopedData_dup;
...
const
  ...
  function CMS_dataFinal_ex(cms: PCMS_ContentInfo; bio: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CMS_dataFinal_ex';
  ...
  function Load_CMS_dataFinal_ex(cms: PCMS_ContentInfo; bio: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl;
...
var
  ...
  CMS_dataFinal_ex: function(cms: PCMS_ContentInfo; bio: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl = Load_CMS_dataFinal_ex;
  ...
  function CMS_final_digest(cms: PCMS_ContentInfo; md: Pbyte; mdlen: TOpenSSL_C_UINT; dcont: PBIO; flags: TOpenSSL_C_UINT): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CMS_final_digest';
  ...
  function CMS_sign_ex(signcert: PX509; pkey: PEVP_PKEY; certs: Pstack_st_X509; data: PBIO; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_sign_ex';
  ...
  function CMS_data_create_ex(in_: PBIO; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_data_create_ex';
  ...
  function CMS_digest_create_ex(in_: PBIO; md: PEVP_MD; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_digest_create_ex';
  ...
  function CMS_EncryptedData_encrypt_ex(in_: PBIO; cipher: PEVP_CIPHER; key: Pbyte; keylen: TOpenSSL_C_SIZET; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_EncryptedData_encrypt_ex';
  ...
  function CMS_encrypt_ex(certs: Pstack_st_X509; in_: PBIO; cipher: PEVP_CIPHER; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_encrypt_ex';
  ...
  function CMS_decrypt_set1_password(cms: PCMS_ContentInfo; pass: Pbyte; passlen: Tossl_ssize_t): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CMS_decrypt_set1_password';
  ...
  function CMS_AuthEnvelopedData_create_ex(cipher: PEVP_CIPHER; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_AuthEnvelopedData_create_ex';
  ...
  function CMS_EnvelopedData_create_ex(cipher: PEVP_CIPHER; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl; external CLibCrypto name 'CMS_EnvelopedData_create_ex';
  function CMS_EnvelopedData_decrypt(env: PCMS_EnvelopedData; detached_data: PBIO; pkey: PEVP_PKEY; cert: PX509; secret: PASN1_OCTET_STRING; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl; external CLibCrypto name 'CMS_EnvelopedData_decrypt';
  ...
  function CMS_RecipientInfo_set0_password(ri: PCMS_RecipientInfo; pass: Pbyte; passlen: Tossl_ssize_t): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CMS_RecipientInfo_set0_password';
  function CMS_add0_recipient_password(cms: PCMS_ContentInfo; iter: TOpenSSL_C_INT; wrap_nid: TOpenSSL_C_INT; pbe_nid: TOpenSSL_C_INT; pass: Pbyte; passlen: Tossl_ssize_t; kekciph: PEVP_CIPHER): PCMS_RecipientInfo; cdecl; external CLibCrypto name 'CMS_add0_recipient_password';
  ...
  function CMS_SignerInfo_verify_ex(si: PCMS_SignerInfo; chain: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CMS_SignerInfo_verify_ex';
  function CMS_SignedData_verify(sd: PCMS_SignedData; detached_data: PBIO; scerts: Pstack_st_X509; store: PX509_STORE; extra: Pstack_st_X509; crls: Pstack_st_X509_CRL; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl; external CLibCrypto name 'CMS_SignedData_verify';
  ...
  function CMS_ReceiptRequest_create0_ex(id: Pbyte; idlen: TOpenSSL_C_INT; allorfirst: TOpenSSL_C_INT; receiptList: Pstack_st_GENERAL_NAMES; receiptsTo: Pstack_st_GENERAL_NAMES; libctx: POSSL_LIB_CTX): PCMS_ReceiptRequest; cdecl; external CLibCrypto name 'CMS_ReceiptRequest_create0_ex';
  ...
  {$EXTERNALSYM CMS_SignerInfo_verify_ex}
  ...
  function Load_CMS_final_digest(cms: PCMS_ContentInfo; md: Pbyte; mdlen: TOpenSSL_C_UINT; dcont: PBIO; flags: TOpenSSL_C_UINT): TOpenSSL_C_INT; cdecl;
  ...
  function Load_CMS_sign_ex(signcert: PX509; pkey: PEVP_PKEY; certs: Pstack_st_X509; data: PBIO; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  ...
  function Load_CMS_data_create_ex(in_: PBIO; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  ...
  function Load_CMS_digest_create_ex(in_: PBIO; md: PEVP_MD; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  ...
  function Load_CMS_EncryptedData_encrypt_ex(in_: PBIO; cipher: PEVP_CIPHER; key: Pbyte; keylen: TOpenSSL_C_SIZET; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  ...
  function Load_CMS_encrypt_ex(certs: Pstack_st_X509; in_: PBIO; cipher: PEVP_CIPHER; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  ...
  function Load_CMS_decrypt_set1_password(cms: PCMS_ContentInfo; pass: Pbyte; passlen: Tossl_ssize_t): TOpenSSL_C_INT; cdecl;
  ...
  function Load_CMS_AuthEnvelopedData_create_ex(cipher: PEVP_CIPHER; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  function Load_CMS_EnvelopedData_create(cipher: PEVP_CIPHER): PCMS_ContentInfo; cdecl;
  function Load_CMS_EnvelopedData_create_ex(cipher: PEVP_CIPHER; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl;
  function Load_CMS_EnvelopedData_decrypt(env: PCMS_EnvelopedData; detached_data: PBIO; pkey: PEVP_PKEY; cert: PX509; secret: PASN1_OCTET_STRING; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl;
  ...
  function Load_CMS_RecipientInfo_set0_password(ri: PCMS_RecipientInfo; pass: Pbyte; passlen: Tossl_ssize_t): TOpenSSL_C_INT; cdecl;
  function Load_CMS_add0_recipient_password(cms: PCMS_ContentInfo; iter: TOpenSSL_C_INT; wrap_nid: TOpenSSL_C_INT; pbe_nid: TOpenSSL_C_INT; pass: Pbyte; passlen: Tossl_ssize_t; kekciph: PEVP_CIPHER): PCMS_RecipientInfo; cdecl;
  ...
  function Load_CMS_SignerInfo_verify_ex(si: PCMS_SignerInfo; chain: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl;
  function Load_CMS_SignedData_verify(sd: PCMS_SignedData; detached_data: PBIO; scerts: Pstack_st_X509; store: PX509_STORE; extra: Pstack_st_X509; crls: Pstack_st_X509_CRL; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl;
  ...
  function Load_CMS_ReceiptRequest_create0_ex(id: Pbyte; idlen: TOpenSSL_C_INT; allorfirst: TOpenSSL_C_INT; receiptList: Pstack_st_GENERAL_NAMES; receiptsTo: Pstack_st_GENERAL_NAMES; libctx: POSSL_LIB_CTX): PCMS_ReceiptRequest; cdecl;
...
var
  ...
  CMS_final_digest: function(cms: PCMS_ContentInfo; md: Pbyte; mdlen: TOpenSSL_C_UINT; dcont: PBIO; flags: TOpenSSL_C_UINT): TOpenSSL_C_INT; cdecl = Load_CMS_final_digest;
  ...
  CMS_sign_ex: function(signcert: PX509; pkey: PEVP_PKEY; certs: Pstack_st_X509; data: PBIO; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_sign_ex;
  ...
  CMS_data_create_ex: function(in_: PBIO; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_data_create_ex;
  ...
  CMS_digest_create_ex: function(in_: PBIO; md: PEVP_MD; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_digest_create_ex;
  ...
  CMS_EncryptedData_encrypt_ex: function(in_: PBIO; cipher: PEVP_CIPHER; key: Pbyte; keylen: TOpenSSL_C_SIZET; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_EncryptedData_encrypt_ex;
  ...
  CMS_encrypt_ex: function(certs: Pstack_st_X509; in_: PBIO; cipher: PEVP_CIPHER; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_encrypt_ex;
  ...
  CMS_decrypt_set1_password: function(cms: PCMS_ContentInfo; pass: Pbyte; passlen: Tossl_ssize_t): TOpenSSL_C_INT; cdecl = Load_CMS_decrypt_set1_password;
  ...
  CMS_AuthEnvelopedData_create_ex: function(cipher: PEVP_CIPHER; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_AuthEnvelopedData_create_ex;
  CMS_EnvelopedData_create: function(cipher: PEVP_CIPHER): PCMS_ContentInfo; cdecl = Load_CMS_EnvelopedData_create;
  CMS_EnvelopedData_create_ex: function(cipher: PEVP_CIPHER; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PCMS_ContentInfo; cdecl = Load_CMS_EnvelopedData_create_ex;
  CMS_EnvelopedData_decrypt: function(env: PCMS_EnvelopedData; detached_data: PBIO; pkey: PEVP_PKEY; cert: PX509; secret: PASN1_OCTET_STRING; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl = Load_CMS_EnvelopedData_decrypt;
  ...
  CMS_RecipientInfo_set0_password: function(ri: PCMS_RecipientInfo; pass: Pbyte; passlen: Tossl_ssize_t): TOpenSSL_C_INT; cdecl = Load_CMS_RecipientInfo_set0_password;
  CMS_add0_recipient_password: function(cms: PCMS_ContentInfo; iter: TOpenSSL_C_INT; wrap_nid: TOpenSSL_C_INT; pbe_nid: TOpenSSL_C_INT; pass: Pbyte; passlen: Tossl_ssize_t; kekciph: PEVP_CIPHER): PCMS_RecipientInfo; cdecl = Load_CMS_add0_recipient_password;
  ...
  CMS_SignerInfo_verify_ex: function(si: PCMS_SignerInfo; chain: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl = Load_CMS_SignerInfo_verify_ex;
  CMS_SignedData_verify: function(sd: PCMS_SignedData; detached_data: PBIO; scerts: Pstack_st_X509; store: PX509_STORE; extra: Pstack_st_X509; crls: Pstack_st_X509_CRL; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl = Load_CMS_SignedData_verify;
  ...
  CMS_ReceiptRequest_create0_ex: function(id: Pbyte; idlen: TOpenSSL_C_INT; allorfirst: TOpenSSL_C_INT; receiptList: Pstack_st_GENERAL_NAMES; receiptsTo: Pstack_st_GENERAL_NAMES; libctx: POSSL_LIB_CTX): PCMS_ReceiptRequest; cdecl = Load_CMS_ReceiptRequest_create0_ex;
...
function sk_CMS_SignerInfo_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_CMS_SignerInfo_cmpfunc_thunk"');

{Error: Line 49: Syntax Error parsing " int (*realcmp)(const CMS_SignerInfo *const *a, const CMS_SignerInfo *const *b) = (int (*)(const 
CMS_SignerInfo *const *a, const CMS_SignerInfo *const *b))(cmp); const CMS_SignerInfo *const *at = (const CMS_SignerInfo *const 
*)a; const CMS_SignerInfo *const *bt = (const CMS_SignerInfo *const *)b; return realcmp(at, bt); "

 int (*realcmp)(const CMS_SignerInfo *const *a, const CMS_SignerInfo *const *b) = (int (*)(const CMS_SignerInfo *const *a, const 
CMS_SignerInfo *const *b))(cmp); const CMS_SignerInfo *const *at = (const CMS_SignerInfo *const *)a; const CMS_SignerInfo *const 
*bt = (const CMS_SignerInfo *const *)b; return realcmp(at, bt); }
end;
...
function sk_CMS_RecipientEncryptedKey_cmpfunc_thunk(cmp: TFuncType001; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_CMS_RecipientEncryptedKey_cmpfunc_thunk"');

{Error: Line 75: Syntax Error parsing " int (*realcmp)(const CMS_RecipientEncryptedKey *const *a, const CMS_RecipientEncryptedKey 
*const *b) = (int (*)(const CMS_RecipientEncryptedKey *const *a, const CMS_RecipientEncryptedKey *const *b))(cmp); const CMS_RecipientEncryptedKey 
*const *at = (const CMS_RecipientEncryptedKey *const *)a; const CMS_RecipientEncryptedKey *const *bt = (const CMS_RecipientEncryptedKey 
*const *)b; return realcmp(at, bt); "

 int (*realcmp)(const CMS_RecipientEncryptedKey *const *a, const CMS_RecipientEncryptedKey *const *b) = (int (*)(const CMS_RecipientEncryptedKey 
*const *a, const CMS_RecipientEncryptedKey *const *b))(cmp); const CMS_RecipientEncryptedKey *const *at = (const CMS_RecipientEncryptedKey 
*const *)a; const CMS_RecipientEncryptedKey *const *bt = (const CMS_RecipientEncryptedKey *const *)b; return realcmp(at, bt); }
end;
...
function sk_CMS_RecipientInfo_cmpfunc_thunk(cmp: TFuncType002; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_CMS_RecipientInfo_cmpfunc_thunk"');

{Error: Line 101: Syntax Error parsing " int (*realcmp)(const CMS_RecipientInfo *const *a, const CMS_RecipientInfo *const *b) = 
(int (*)(const CMS_RecipientInfo *const *a, const CMS_RecipientInfo *const *b))(cmp); const CMS_RecipientInfo *const *at = (const 
CMS_RecipientInfo *const *)a; const CMS_RecipientInfo *const *bt = (const CMS_RecipientInfo *const *)b; return realcmp(at, bt); 
"

 int (*realcmp)(const CMS_RecipientInfo *const *a, const CMS_RecipientInfo *const *b) = (int (*)(const CMS_RecipientInfo *const 
*a, const CMS_RecipientInfo *const *b))(cmp); const CMS_RecipientInfo *const *at = (const CMS_RecipientInfo *const *)a; const CMS_RecipientInfo 
*const *bt = (const CMS_RecipientInfo *const *)b; return realcmp(at, bt); }
end;
...
function sk_CMS_RevocationInfoChoice_cmpfunc_thunk(cmp: TFuncType003; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_CMS_RevocationInfoChoice_cmpfunc_thunk"');

{Error: Line 127: Syntax Error parsing " int (*realcmp)(const CMS_RevocationInfoChoice *const *a, const CMS_RevocationInfoChoice 
*const *b) = (int (*)(const CMS_RevocationInfoChoice *const *a, const CMS_RevocationInfoChoice *const *b))(cmp); const CMS_RevocationInfoChoice 
*const *at = (const CMS_RevocationInfoChoice *const *)a; const CMS_RevocationInfoChoice *const *bt = (const CMS_RevocationInfoChoice 
*const *)b; return realcmp(at, bt); "

 int (*realcmp)(const CMS_RevocationInfoChoice *const *a, const CMS_RevocationInfoChoice *const *b) = (int (*)(const CMS_RevocationInfoChoice 
*const *a, const CMS_RevocationInfoChoice *const *b))(cmp); const CMS_RevocationInfoChoice *const *at = (const CMS_RevocationInfoChoice 
*const *)a; const CMS_RevocationInfoChoice *const *bt = (const CMS_RevocationInfoChoice *const *)b; return realcmp(at, bt); }
end;
...
function Load_CMS_EnvelopedData_it: PASN1_ITEM; cdecl;
begin
  CMS_EnvelopedData_it := LoadLibCryptoFunction('CMS_EnvelopedData_it');
  if not assigned(CMS_EnvelopedData_it) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_EnvelopedData_it');
  Result := CMS_EnvelopedData_it;
end;

function Load_CMS_SignedData_new: PCMS_SignedData; cdecl;
begin
  CMS_SignedData_new := LoadLibCryptoFunction('CMS_SignedData_new');
  if not assigned(CMS_SignedData_new) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_SignedData_new');
  Result := CMS_SignedData_new;
end;

procedure Load_CMS_SignedData_free(a: PCMS_SignedData); cdecl;
begin
  CMS_SignedData_free := LoadLibCryptoFunction('CMS_SignedData_free');
  if not assigned(CMS_SignedData_free) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_SignedData_free');
  CMS_SignedData_free(a);
end;
...
function Load_CMS_EnvelopedData_dup(a: PCMS_EnvelopedData): PCMS_EnvelopedData; cdecl;
begin
  CMS_EnvelopedData_dup := LoadLibCryptoFunction('CMS_EnvelopedData_dup');
  if not assigned(CMS_EnvelopedData_dup) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_EnvelopedData_dup');
  Result := CMS_EnvelopedData_dup(a);
end;
...
function Load_CMS_dataFinal_ex(cms: PCMS_ContentInfo; bio: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl;
begin
  CMS_dataFinal_ex := LoadLibCryptoFunction('CMS_dataFinal_ex');
  if not assigned(CMS_dataFinal_ex) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_dataFinal_ex');
  Result := CMS_dataFinal_ex(cms, bio, data);
end;
...
function Load_CMS_final_digest(cms: PCMS_ContentInfo; md: Pbyte; mdlen: TOpenSSL_C_UINT; dcont: PBIO; flags: TOpenSSL_C_UINT): TOpenSSL_C_INT; cdecl;
begin
  CMS_final_digest := LoadLibCryptoFunction('CMS_final_digest');
  if not assigned(CMS_final_digest) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_final_digest');
  Result := CMS_final_digest(cms, md, mdlen, dcont, flags);
end;
...
begin
  ...
  Result := CMS_sign_ex(signcert, pkey, certs, data, flags, libctx, propq);
end;
...
begin
  ...
  Result := CMS_data_create_ex(in_, flags, libctx, propq);
end;
...
begin
  ...
  Result := CMS_digest_create_ex(in_, md, flags, libctx, propq);
end;
...
begin
  ...
  Result := CMS_EncryptedData_encrypt_ex(in_, cipher, key, keylen, flags, libctx, propq);
end;
...
begin
  ...
  Result := CMS_encrypt_ex(certs, in_, cipher, flags, libctx, propq);
end;
...
begin
  ...
  Result := CMS_AuthEnvelopedData_create_ex(cipher, libctx, propq);
end;
...
begin
  ...
  Result := CMS_EnvelopedData_create_ex(cipher, libctx, propq);
end;

function Load_CMS_EnvelopedData_decrypt(env: PCMS_EnvelopedData; detached_data: PBIO; pkey: PEVP_PKEY; cert: PX509; secret: PASN1_OCTET_STRING; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl;
begin
  CMS_EnvelopedData_decrypt := LoadLibCryptoFunction('CMS_EnvelopedData_decrypt');
  if not assigned(CMS_EnvelopedData_decrypt) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_EnvelopedData_decrypt');
  Result := CMS_EnvelopedData_decrypt(env, detached_data, pkey, cert, secret, flags, libctx, propq);
end;
...
function Load_CMS_SignerInfo_verify_ex(si: PCMS_SignerInfo; chain: PBIO; data: PBIO): TOpenSSL_C_INT; cdecl;
begin
  CMS_SignerInfo_verify_ex := LoadLibCryptoFunction('CMS_SignerInfo_verify_ex');
  if not assigned(CMS_SignerInfo_verify_ex) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_SignerInfo_verify_ex');
  Result := CMS_SignerInfo_verify_ex(si, chain, data);
end;

function Load_CMS_SignedData_verify(sd: PCMS_SignedData; detached_data: PBIO; scerts: Pstack_st_X509; store: PX509_STORE; extra: Pstack_st_X509; crls: Pstack_st_X509_CRL; flags: TOpenSSL_C_UINT; libctx: POSSL_LIB_CTX; propq: PAnsiChar): PBIO; cdecl;
begin
  CMS_SignedData_verify := LoadLibCryptoFunction('CMS_SignedData_verify');
  if not assigned(CMS_SignedData_verify) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CMS_SignedData_verify');
  Result := CMS_SignedData_verify(sd, detached_data, scerts, store, extra, crls, flags, libctx, propq);
end;
...
begin
  ...
  Result := CMS_ReceiptRequest_create0_ex(id, idlen, allorfirst, receiptList, receiptsTo, libctx);
end;
...
begin
{$ifndef  OPENSSL_NO_CMS}
  CMS_EnvelopedData_it := Load_CMS_EnvelopedData_it;
  CMS_SignedData_new := Load_CMS_SignedData_new;
  CMS_SignedData_free := Load_CMS_SignedData_free;
  ...
  CMS_EnvelopedData_dup := Load_CMS_EnvelopedData_dup;
  ...
  CMS_dataFinal_ex := Load_CMS_dataFinal_ex;
  ...
  CMS_final_digest := Load_CMS_final_digest;
  ...
  CMS_EnvelopedData_decrypt := Load_CMS_EnvelopedData_decrypt;
  ...
  CMS_SignerInfo_verify_ex := Load_CMS_SignerInfo_verify_ex;
  CMS_SignedData_verify := Load_CMS_SignedData_verify;
