...
type
  ...
  function sk_OCSP_RESPONSE_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
type
  ...
  function sk_X509_LOOKUP_cmpfunc_thunk(cmp: TFuncType001; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
type
  ...
  function sk_X509_OBJECT_cmpfunc_thunk(cmp: TFuncType002; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
type
  ...
  function sk_X509_VERIFY_PARAM_cmpfunc_thunk(cmp: TFuncType003; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
type
  ...
  TFuncType004 = function(_param1: Px509_trust_st; _param2: PX509; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
  Tx509_trust_st = record 
    trust: TOpenSSL_C_INT;
    flags: TOpenSSL_C_INT;
    check_trust: TFuncType004;
    name: PAnsiChar;
    arg1: TOpenSSL_C_INT;
    arg2: pointer;
  end;
...
type
  ...
  function sk_X509_TRUST_cmpfunc_thunk(cmp: TFuncType005; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
type
  ...
  TFuncType006 = function(_param1: PX509_TRUST; _param2: PX509; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_TRUST_add(id: TOpenSSL_C_INT; flags: TOpenSSL_C_INT; ck: TFuncType006; name: PAnsiChar; arg1: TOpenSSL_C_INT; arg2: pointer): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_TRUST_add';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_TRUST_add(id: TOpenSSL_C_INT; flags: TOpenSSL_C_INT; ck: TFuncType006; name: PAnsiChar; arg1: TOpenSSL_C_INT; arg2: pointer): TOpenSSL_C_INT; cdecl;
...
var
  X509_TRUST_add: function(id: TOpenSSL_C_INT; flags: TOpenSSL_C_INT; ck: TFuncType006; name: PAnsiChar; arg1: TOpenSSL_C_INT; arg2: pointer): TOpenSSL_C_INT; cdecl = Load_X509_TRUST_add;
...
type
  ...
  TFuncType007 = function(_param1: TOpenSSL_C_INT; _param2: PX509; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
  TFuncType008 = function(_param1: TOpenSSL_C_INT; _param2: PX509; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_TRUST_set_default(trust: TFuncType007): TFuncType008; cdecl; external CLibCrypto name 'X509_TRUST_set_default';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_TRUST_set_default(trust: TFuncType007): TFuncType008; cdecl;
...
var
  X509_TRUST_set_default: function(trust: TFuncType007): TFuncType008; cdecl = Load_X509_TRUST_set_default;
...
var
  ...
  {$ifndef  OPENSSL_NO_DEPRECATED_4_0}
    ...
    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_STORE_get0_objects(xs: PX509_STORE): Pstack_st_X509_OBJECT; cdecl; external CLibCrypto name 'X509_STORE_get0_objects'; deprecated 'Since OpenSSL 4.0;Use X509_STORE_get1_objects';
    {$else}
...
var
 ...
 freef)} {Macro Return Type unknown at line no 590}
...
type
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_set_new_item(method: PX509_LOOKUP_METHOD; new_item: TFuncType009): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_set_new_item';
  {$else}
  {$EXTERNALSYM X509_LOOKUP_meth_set_new_item}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_set_new_item(method: PX509_LOOKUP_METHOD; new_item: TFuncType009): TOpenSSL_C_INT; cdecl;

var
  X509_LOOKUP_meth_set_new_item: function(method: PX509_LOOKUP_METHOD; new_item: TFuncType009): TOpenSSL_C_INT; cdecl = Load_X509_LOOKUP_meth_set_new_item;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_get_new_item(method: PX509_LOOKUP_METHOD): TFuncType010; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_get_new_item';
  {$else}
  {$EXTERNALSYM X509_LOOKUP_meth_get_new_item}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_get_new_item(method: PX509_LOOKUP_METHOD): TFuncType010; cdecl;

var
  X509_LOOKUP_meth_get_new_item: function(method: PX509_LOOKUP_METHOD): TFuncType010; cdecl = Load_X509_LOOKUP_meth_get_new_item;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType011 = procedure(ctx: PX509_LOOKUP); cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_set_free(method: PX509_LOOKUP_METHOD; free_fn: TFuncType011): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_set_free';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_set_free(method: PX509_LOOKUP_METHOD; free_fn: TFuncType011): TOpenSSL_C_INT; cdecl;
  function Load_X509_LOOKUP_meth_get_free(method: PX509_LOOKUP_METHOD): pointer; cdecl;

var
  X509_LOOKUP_meth_set_free: function(method: PX509_LOOKUP_METHOD; free_fn: TFuncType011): TOpenSSL_C_INT; cdecl = Load_X509_LOOKUP_meth_set_free;
...
type
  ...
  TFuncType012 = function(ctx: PX509_LOOKUP): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_set_init(method: PX509_LOOKUP_METHOD; init: TFuncType012): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_set_init';
  {$else}
  {$EXTERNALSYM X509_LOOKUP_meth_set_init}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_set_init(method: PX509_LOOKUP_METHOD; init: TFuncType012): TOpenSSL_C_INT; cdecl;

var
  X509_LOOKUP_meth_set_init: function(method: PX509_LOOKUP_METHOD; init: TFuncType012): TOpenSSL_C_INT; cdecl = Load_X509_LOOKUP_meth_set_init;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType013 = function(ctx: PX509_LOOKUP): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_get_init(method: PX509_LOOKUP_METHOD): TFuncType013; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_get_init';
  {$else}
  {$EXTERNALSYM X509_LOOKUP_meth_get_init}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_get_init(method: PX509_LOOKUP_METHOD): TFuncType013; cdecl;

var
  X509_LOOKUP_meth_get_init: function(method: PX509_LOOKUP_METHOD): TFuncType013; cdecl = Load_X509_LOOKUP_meth_get_init;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType014 = function(ctx: PX509_LOOKUP): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_set_shutdown(method: PX509_LOOKUP_METHOD; shutdown: TFuncType014): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_set_shutdown';
  {$else}
  {$EXTERNALSYM X509_LOOKUP_meth_set_shutdown}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_set_shutdown(method: PX509_LOOKUP_METHOD; shutdown: TFuncType014): TOpenSSL_C_INT; cdecl;

var
  X509_LOOKUP_meth_set_shutdown: function(method: PX509_LOOKUP_METHOD; shutdown: TFuncType014): TOpenSSL_C_INT; cdecl = Load_X509_LOOKUP_meth_set_shutdown;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType015 = function(ctx: PX509_LOOKUP): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function X509_LOOKUP_meth_get_shutdown(method: PX509_LOOKUP_METHOD): TFuncType015; cdecl; external CLibCrypto name 'X509_LOOKUP_meth_get_shutdown';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_X509_LOOKUP_meth_get_shutdown(method: PX509_LOOKUP_METHOD): TFuncType015; cdecl;
...
var
  X509_LOOKUP_meth_get_shutdown: function(method: PX509_LOOKUP_METHOD): TFuncType015; cdecl = Load_X509_LOOKUP_meth_get_shutdown;
 ...
 dupf, freef)} {Macro Return Type unknown at line no 784}
...
type
  ...
  TFuncType016 = function(name: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  procedure X509_VERIFY_PARAM_set1_host_input_validation(param: PX509_VERIFY_PARAM; validate_host: TFuncType016); cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_set1_host_input_validation';
  ...
  function X509_VERIFY_PARAM_set1_rfc822(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_set1_rfc822';
  function X509_VERIFY_PARAM_add1_rfc822(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_add1_rfc822';
  {$else}
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_host_input_validation}
  ...
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_rfc822}
  {$EXTERNALSYM X509_VERIFY_PARAM_add1_rfc822}
  {Do not call Function LoadDeclarations. Internal use only}
  procedure Load_X509_VERIFY_PARAM_set1_host_input_validation(param: PX509_VERIFY_PARAM; validate_host: TFuncType016); cdecl;
  ...
  function Load_X509_VERIFY_PARAM_set1_rfc822(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
  function Load_X509_VERIFY_PARAM_add1_rfc822(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;

var
  X509_VERIFY_PARAM_set1_host_input_validation: procedure(param: PX509_VERIFY_PARAM; validate_host: TFuncType016); cdecl = Load_X509_VERIFY_PARAM_set1_host_input_validation;
  ...
  X509_VERIFY_PARAM_set1_rfc822: function(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_X509_VERIFY_PARAM_set1_rfc822;
  X509_VERIFY_PARAM_add1_rfc822: function(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_X509_VERIFY_PARAM_add1_rfc822;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType017 = function(name: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  procedure X509_VERIFY_PARAM_set1_rfc822_input_validation(param: PX509_VERIFY_PARAM; validate_rfc822: TFuncType017); cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_set1_rfc822_input_validation';
  function X509_VERIFY_PARAM_set1_smtputf8(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_set1_smtputf8';
  function X509_VERIFY_PARAM_add1_smtputf8(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_add1_smtputf8';
  {$else}
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_rfc822_input_validation}
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_smtputf8}
  {$EXTERNALSYM X509_VERIFY_PARAM_add1_smtputf8}
  {Do not call Function LoadDeclarations. Internal use only}
  procedure Load_X509_VERIFY_PARAM_set1_rfc822_input_validation(param: PX509_VERIFY_PARAM; validate_rfc822: TFuncType017); cdecl;
  function Load_X509_VERIFY_PARAM_set1_smtputf8(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
  function Load_X509_VERIFY_PARAM_add1_smtputf8(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;

var
  X509_VERIFY_PARAM_set1_rfc822_input_validation: procedure(param: PX509_VERIFY_PARAM; validate_rfc822: TFuncType017); cdecl = Load_X509_VERIFY_PARAM_set1_rfc822_input_validation;
  X509_VERIFY_PARAM_set1_smtputf8: function(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_X509_VERIFY_PARAM_set1_smtputf8;
  X509_VERIFY_PARAM_add1_smtputf8: function(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_X509_VERIFY_PARAM_add1_smtputf8;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType018 = function(name: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  procedure X509_VERIFY_PARAM_set1_smtputf8_input_validation(param: PX509_VERIFY_PARAM; validate_smtputf8: TFuncType018); cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_set1_smtputf8_input_validation';
  ...
  {$else}
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_smtputf8_input_validation}
  {$EXTERNALSYM X509_VERIFY_PARAM_get1_ip_asc}
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_ip}
  {Do not call Function LoadDeclarations. Internal use only}
  procedure Load_X509_VERIFY_PARAM_set1_smtputf8_input_validation(param: PX509_VERIFY_PARAM; validate_smtputf8: TFuncType018); cdecl;
...
var
  X509_VERIFY_PARAM_set1_smtputf8_input_validation: procedure(param: PX509_VERIFY_PARAM; validate_smtputf8: TFuncType018); cdecl = Load_X509_VERIFY_PARAM_set1_smtputf8_input_validation;
...
type
  ...
  TFuncType019 = function(name: Pbyte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  procedure X509_VERIFY_PARAM_set1_ip_input_validation(param: PX509_VERIFY_PARAM; validate_ip: TFuncType019); cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_set1_ip_input_validation';
  ...
  function X509_VERIFY_PARAM_add1_ip(param: PX509_VERIFY_PARAM; ip: Pbyte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_add1_ip';
  function X509_VERIFY_PARAM_add1_ip_asc(param: PX509_VERIFY_PARAM; ipasc: PAnsiChar): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'X509_VERIFY_PARAM_add1_ip_asc';
  ...
  {$else}
  {$EXTERNALSYM X509_VERIFY_PARAM_set1_ip_input_validation}
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  procedure Load_X509_VERIFY_PARAM_set1_ip_input_validation(param: PX509_VERIFY_PARAM; validate_ip: TFuncType019); cdecl;
  function Load_X509_VERIFY_PARAM_set1_ip_asc(param: PX509_VERIFY_PARAM; ipasc: PAnsiChar): TOpenSSL_C_INT; cdecl;
  function Load_X509_VERIFY_PARAM_add1_ip(param: PX509_VERIFY_PARAM; ip: Pbyte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
  function Load_X509_VERIFY_PARAM_add1_ip_asc(param: PX509_VERIFY_PARAM; ipasc: PAnsiChar): TOpenSSL_C_INT; cdecl;
...
var
  X509_VERIFY_PARAM_set1_ip_input_validation: procedure(param: PX509_VERIFY_PARAM; validate_ip: TFuncType019); cdecl = Load_X509_VERIFY_PARAM_set1_ip_input_validation;
  ...
  X509_VERIFY_PARAM_add1_ip: function(param: PX509_VERIFY_PARAM; ip: Pbyte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl = Load_X509_VERIFY_PARAM_add1_ip;
  X509_VERIFY_PARAM_add1_ip_asc: function(param: PX509_VERIFY_PARAM; ipasc: PAnsiChar): TOpenSSL_C_INT; cdecl = Load_X509_VERIFY_PARAM_add1_ip_asc;
...
function sk_OCSP_RESPONSE_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_OCSP_RESPONSE_cmpfunc_thunk"');

{Error: Line 47: Syntax Error parsing " int (*realcmp)(const OCSP_RESPONSE *const *a, const OCSP_RESPONSE *const *b) = (int (*)(const 
OCSP_RESPONSE *const *a, const OCSP_RESPONSE *const *b))(cmp); const OCSP_RESPONSE *const *at = (const OCSP_RESPONSE *const *)a; 
const OCSP_RESPONSE *const *bt = (const OCSP_RESPONSE *const *)b; return realcmp(at, bt); "

 int (*realcmp)(const OCSP_RESPONSE *const *a, const OCSP_RESPONSE *const *b) = (int (*)(const OCSP_RESPONSE *const *a, const OCSP_RESPONSE 
*const *b))(cmp); const OCSP_RESPONSE *const *at = (const OCSP_RESPONSE *const *)a; const OCSP_RESPONSE *const *bt = (const OCSP_RESPONSE 
...
f_thunk; f_thunk = (OPENSSL_sk_freefunc_thunk)sk_OCSP_RESPONSE_freefunc_thunk; OPENSSL_sk_set_cmp_thunks(ret, sk_OCSP_RESPONSE_cmpfunc_thunk); 
...
OPENSSL_sk_set_cmp_thunks(ret, sk_OCSP_RESPONSE_cmpfunc_thunk); return (struct stack_st_OCSP_RESPONSE *)OPENSSL_sk_set_thunks(ret,
 f_thunk); }
end;

function sk_OCSP_RESPONSE_new_null: Pstack_st_OCSP_RESPONSE{Has C Attribute: unused}; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_OCSP_RESPONSE_new_null"');

{Error: Line 47: Syntax Error parsing " OPENSSL_STACK *ret = OPENSSL_sk_new_null(); OPENSSL_sk_freefunc_thunk f_thunk; f_thunk = 
(OPENSSL_sk_freefunc_thunk)sk_OCSP_RESPONSE_freefunc_thunk; return (struct stack_st_OCSP_RESPONSE *)OPENSSL_sk_set_thunks(ret, f_thunk); 
"

 OPENSSL_STACK *ret = OPENSSL_sk_new_null(); OPENSSL_sk_freefunc_thunk f_thunk; f_thunk = (OPENSSL_sk_freefunc_thunk)sk_OCSP_RESPONSE_freefunc_thunk; 
return (struct stack_st_OCSP_RESPONSE *)OPENSSL_sk_set_thunks(ret, f_thunk); }
end;
...
function sk_X509_LOOKUP_cmpfunc_thunk(cmp: TFuncType001; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_X509_LOOKUP_cmpfunc_thunk"');

{Error: Line 78: Syntax Error parsing " int (*realcmp)(const X509_LOOKUP *const *a, const X509_LOOKUP *const *b) = (int (*)(const 
X509_LOOKUP *const *a, const X509_LOOKUP *const *b))(cmp); const X509_LOOKUP *const *at = (const X509_LOOKUP *const *)a; const X509_LOOKUP 
*const *bt = (const X509_LOOKUP *const *)b; return realcmp(at, bt); "

 int (*realcmp)(const X509_LOOKUP *const *a, const X509_LOOKUP *const *b) = (int (*)(const X509_LOOKUP *const *a, const X509_LOOKUP 
*const *b))(cmp); const X509_LOOKUP *const *at = (const X509_LOOKUP *const *)a; const X509_LOOKUP *const *bt = (const X509_LOOKUP 
*const *)b; return realcmp(at, bt); }
end;
...
function sk_X509_OBJECT_cmpfunc_thunk(cmp: TFuncType002; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_X509_OBJECT_cmpfunc_thunk"');

{Error: Line 104: Syntax Error parsing " int (*realcmp)(const X509_OBJECT *const *a, const X509_OBJECT *const *b) = (int (*)(const 
X509_OBJECT *const *a, const X509_OBJECT *const *b))(cmp); const X509_OBJECT *const *at = (const X509_OBJECT *const *)a; const X509_OBJECT 
*const *bt = (const X509_OBJECT *const *)b; return realcmp(at, bt); "

 int (*realcmp)(const X509_OBJECT *const *a, const X509_OBJECT *const *b) = (int (*)(const X509_OBJECT *const *a, const X509_OBJECT 
*const *b))(cmp); const X509_OBJECT *const *at = (const X509_OBJECT *const *)a; const X509_OBJECT *const *bt = (const X509_OBJECT 
*const *)b; return realcmp(at, bt); }
end;
...
function sk_X509_VERIFY_PARAM_cmpfunc_thunk(cmp: TFuncType003; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_X509_VERIFY_PARAM_cmpfunc_thunk"');

{Error: Line 130: Syntax Error parsing " int (*realcmp)(const X509_VERIFY_PARAM *const *a, const X509_VERIFY_PARAM *const *b) = 
(int (*)(const X509_VERIFY_PARAM *const *a, const X509_VERIFY_PARAM *const *b))(cmp); const X509_VERIFY_PARAM *const *at = (const 
X509_VERIFY_PARAM *const *)a; const X509_VERIFY_PARAM *const *bt = (const X509_VERIFY_PARAM *const *)b; return realcmp(at, bt); 
"

 int (*realcmp)(const X509_VERIFY_PARAM *const *a, const X509_VERIFY_PARAM *const *b) = (int (*)(const X509_VERIFY_PARAM *const 
*a, const X509_VERIFY_PARAM *const *b))(cmp); const X509_VERIFY_PARAM *const *at = (const X509_VERIFY_PARAM *const *)a; const X509_VERIFY_PARAM 
*const *bt = (const X509_VERIFY_PARAM *const *)b; return realcmp(at, bt); }
end;
...
function sk_X509_TRUST_cmpfunc_thunk(cmp: TFuncType005; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_X509_TRUST_cmpfunc_thunk"');

{Error: Line 169: Syntax Error parsing " int (*realcmp)(const X509_TRUST *const *a, const X509_TRUST *const *b) = (int (*)(const 
X509_TRUST *const *a, const X509_TRUST *const *b))(cmp); const X509_TRUST *const *at = (const X509_TRUST *const *)a; const X509_TRUST 
*const *bt = (const X509_TRUST *const *)b; return realcmp(at, bt); "

 int (*realcmp)(const X509_TRUST *const *a, const X509_TRUST *const *b) = (int (*)(const X509_TRUST *const *a, const X509_TRUST 
*const *b))(cmp); const X509_TRUST *const *at = (const X509_TRUST *const *)a; const X509_TRUST *const *bt = (const X509_TRUST *const 
...
procedure Load_X509_VERIFY_PARAM_set1_host_input_validation(param: PX509_VERIFY_PARAM; validate_host: TFuncType016); cdecl;
begin
  X509_VERIFY_PARAM_set1_host_input_validation := LoadLibCryptoFunction('X509_VERIFY_PARAM_set1_host_input_validation');
  if not assigned(X509_VERIFY_PARAM_set1_host_input_validation) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_set1_host_input_validation');
  X509_VERIFY_PARAM_set1_host_input_validation(param, validate_host);
end;
...
function Load_X509_VERIFY_PARAM_set1_rfc822(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
begin
  X509_VERIFY_PARAM_set1_rfc822 := LoadLibCryptoFunction('X509_VERIFY_PARAM_set1_rfc822');
  if not assigned(X509_VERIFY_PARAM_set1_rfc822) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_set1_rfc822');
  Result := X509_VERIFY_PARAM_set1_rfc822(param, email, emaillen);
end;

function Load_X509_VERIFY_PARAM_add1_rfc822(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
begin
  X509_VERIFY_PARAM_add1_rfc822 := LoadLibCryptoFunction('X509_VERIFY_PARAM_add1_rfc822');
  if not assigned(X509_VERIFY_PARAM_add1_rfc822) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_add1_rfc822');
  Result := X509_VERIFY_PARAM_add1_rfc822(param, email, len);
end;

procedure Load_X509_VERIFY_PARAM_set1_rfc822_input_validation(param: PX509_VERIFY_PARAM; validate_rfc822: TFuncType017); cdecl;
begin
  X509_VERIFY_PARAM_set1_rfc822_input_validation := LoadLibCryptoFunction('X509_VERIFY_PARAM_set1_rfc822_input_validation');
  if not assigned(X509_VERIFY_PARAM_set1_rfc822_input_validation) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_set1_rfc822_input_validation');
  X509_VERIFY_PARAM_set1_rfc822_input_validation(param, validate_rfc822);
end;

function Load_X509_VERIFY_PARAM_set1_smtputf8(param: PX509_VERIFY_PARAM; email: PAnsiChar; emaillen: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
begin
  X509_VERIFY_PARAM_set1_smtputf8 := LoadLibCryptoFunction('X509_VERIFY_PARAM_set1_smtputf8');
  if not assigned(X509_VERIFY_PARAM_set1_smtputf8) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_set1_smtputf8');
  Result := X509_VERIFY_PARAM_set1_smtputf8(param, email, emaillen);
end;

function Load_X509_VERIFY_PARAM_add1_smtputf8(param: PX509_VERIFY_PARAM; email: PAnsiChar; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
begin
  X509_VERIFY_PARAM_add1_smtputf8 := LoadLibCryptoFunction('X509_VERIFY_PARAM_add1_smtputf8');
  if not assigned(X509_VERIFY_PARAM_add1_smtputf8) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_add1_smtputf8');
  Result := X509_VERIFY_PARAM_add1_smtputf8(param, email, len);
end;

procedure Load_X509_VERIFY_PARAM_set1_smtputf8_input_validation(param: PX509_VERIFY_PARAM; validate_smtputf8: TFuncType018); cdecl;
begin
  X509_VERIFY_PARAM_set1_smtputf8_input_validation := LoadLibCryptoFunction('X509_VERIFY_PARAM_set1_smtputf8_input_validation');
  if not assigned(X509_VERIFY_PARAM_set1_smtputf8_input_validation) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_set1_smtputf8_input_validation');
  X509_VERIFY_PARAM_set1_smtputf8_input_validation(param, validate_smtputf8);
end;
...
procedure Load_X509_VERIFY_PARAM_set1_ip_input_validation(param: PX509_VERIFY_PARAM; validate_ip: TFuncType019); cdecl;
begin
  X509_VERIFY_PARAM_set1_ip_input_validation := LoadLibCryptoFunction('X509_VERIFY_PARAM_set1_ip_input_validation');
  if not assigned(X509_VERIFY_PARAM_set1_ip_input_validation) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_set1_ip_input_validation');
  X509_VERIFY_PARAM_set1_ip_input_validation(param, validate_ip);
end;
...
function Load_X509_VERIFY_PARAM_add1_ip(param: PX509_VERIFY_PARAM; ip: Pbyte; len: TOpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;
begin
  X509_VERIFY_PARAM_add1_ip := LoadLibCryptoFunction('X509_VERIFY_PARAM_add1_ip');
  if not assigned(X509_VERIFY_PARAM_add1_ip) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_add1_ip');
  Result := X509_VERIFY_PARAM_add1_ip(param, ip, len);
end;

function Load_X509_VERIFY_PARAM_add1_ip_asc(param: PX509_VERIFY_PARAM; ipasc: PAnsiChar): TOpenSSL_C_INT; cdecl;
begin
  X509_VERIFY_PARAM_add1_ip_asc := LoadLibCryptoFunction('X509_VERIFY_PARAM_add1_ip_asc');
  if not assigned(X509_VERIFY_PARAM_add1_ip_asc) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('X509_VERIFY_PARAM_add1_ip_asc');
  Result := X509_VERIFY_PARAM_add1_ip_asc(param, ipasc);
end;
...
{$endif} { OPENSSL_NO_OCSP}
  ...
  X509_VERIFY_PARAM_set1_host_input_validation := Load_X509_VERIFY_PARAM_set1_host_input_validation;
  ...
  X509_VERIFY_PARAM_set1_rfc822 := Load_X509_VERIFY_PARAM_set1_rfc822;
  X509_VERIFY_PARAM_add1_rfc822 := Load_X509_VERIFY_PARAM_add1_rfc822;
  X509_VERIFY_PARAM_set1_rfc822_input_validation := Load_X509_VERIFY_PARAM_set1_rfc822_input_validation;
  X509_VERIFY_PARAM_set1_smtputf8 := Load_X509_VERIFY_PARAM_set1_smtputf8;
  X509_VERIFY_PARAM_add1_smtputf8 := Load_X509_VERIFY_PARAM_add1_smtputf8;
  X509_VERIFY_PARAM_set1_smtputf8_input_validation := Load_X509_VERIFY_PARAM_set1_smtputf8_input_validation;
  X509_VERIFY_PARAM_get1_ip_asc := Load_X509_VERIFY_PARAM_get1_ip_asc;
  X509_VERIFY_PARAM_set1_ip := Load_X509_VERIFY_PARAM_set1_ip;
  X509_VERIFY_PARAM_set1_ip_input_validation := Load_X509_VERIFY_PARAM_set1_ip_input_validation;
  X509_VERIFY_PARAM_set1_ip_asc := Load_X509_VERIFY_PARAM_set1_ip_asc;
  X509_VERIFY_PARAM_add1_ip := Load_X509_VERIFY_PARAM_add1_ip;
  X509_VERIFY_PARAM_add1_ip_asc := Load_X509_VERIFY_PARAM_add1_ip_asc;
