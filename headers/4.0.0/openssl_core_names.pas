...
{
  Generated from OpenSSL 4.0.0 Header File core_names.h - Tue 19 May 14:32:15 BST 2026
}
...
const
  ...
  OSSL_KDF_NAME_HKDF_SHA256 = 'HKDF-SHA256';
  OSSL_KDF_NAME_HKDF_SHA384 = 'HKDF-SHA384';
  OSSL_KDF_NAME_HKDF_SHA512 = 'HKDF-SHA512';
  OSSL_KDF_NAME_TLS1_3_KDF = 'TLS13-KDF';
  OSSL_KDF_NAME_PBKDF1 = 'PBKDF1';
  OSSL_KDF_NAME_PBKDF2 = 'PBKDF2';
  OSSL_KDF_NAME_SCRYPT = 'SCRYPT';
  OSSL_KDF_NAME_SNMPKDF = 'SNMPKDF';
  OSSL_KDF_NAME_SRTPKDF = 'SRTPKDF';
  ...
  OSSL_ALG_PARAM_SECURITY_CATEGORY = 'security-category';
  ...
  OSSL_CIPHER_PARAM_ENCRYPT_THEN_MAC = 'encrypt-then-mac';
  ...
  OSSL_DIGEST_PARAM_CUSTOMIZATION = 'customization';
  OSSL_DIGEST_PARAM_FUNCTION_NAME = 'function-name';
  OSSL_DIGEST_PARAM_MICALG = 'micalg';
  OSSL_DIGEST_PARAM_MU_CONTEXT_STRING = 'context-string';
  OSSL_DIGEST_PARAM_MU_DIGEST = OSSL_ALG_PARAM_DIGEST;
  OSSL_DIGEST_PARAM_MU_PROPERTIES = OSSL_ALG_PARAM_PROPERTIES;
  OSSL_DIGEST_PARAM_MU_PUB_KEY = 'pub';
  OSSL_DIGEST_PARAM_PAD_TYPE = 'pad-type';
  OSSL_DIGEST_PARAM_PROPERTIES = OSSL_ALG_PARAM_PROPERTIES;
  ...
  OSSL_KDF_PARAM_SNMPKDF_EID = 'eid';
  OSSL_KDF_PARAM_SRTPKDF_INDEX = 'index';
  OSSL_KDF_PARAM_SRTPKDF_KDR = 'kdr';
  OSSL_KDF_PARAM_SRTPKDF_LABEL = 'label';
  ...
  OSSL_PKEY_PARAM_CMS_RI_TYPE = 'ri-type';
