...
{
  Generated from OpenSSL 4.0.0 Header File evperr.h - Tue 19 May 14:32:40 BST 2026
}
...
const
  ...
  EVP_R_PIPELINE_NOT_SUPPORTED = 230;
  EVP_R_PKEY_APPLICATION_ASN1_METHOD_ALREADY_REGISTERED = 179;
  EVP_R_PRIVATE_KEY_DECODE_ERROR = 145;
  EVP_R_PRIVATE_KEY_ENCODE_ERROR = 146;
  EVP_R_PROVIDER_ASYM_CIPHER_FAILURE = 232;
  EVP_R_PROVIDER_ASYM_CIPHER_NOT_SUPPORTED = 235;
  EVP_R_PROVIDER_GET_CTX_PARAMS_NOT_SUPPORTED = 238;
  EVP_R_PROVIDER_KEYMGMT_FAILURE = 233;
  EVP_R_PROVIDER_KEYMGMT_NOT_SUPPORTED = 236;
  EVP_R_PROVIDER_SIGNATURE_FAILURE = 234;
  EVP_R_PROVIDER_SIGNATURE_NOT_SUPPORTED = 237;
