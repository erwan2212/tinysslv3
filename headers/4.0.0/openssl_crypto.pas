...
{
  Generated from OpenSSL 4.0.0 Header File crypto.h - Tue 19 May 14:32:20 BST 2026
}
...
type
  ...
  function CRYPTO_atomic_store_int(dst: POpenSSL_C_INT; val: TOpenSSL_C_INT; lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CRYPTO_atomic_store_int';
  ...
  function Load_CRYPTO_atomic_store_int(dst: POpenSSL_C_INT; val: TOpenSSL_C_INT; lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl;
...
var
  ...
  CRYPTO_atomic_store_int: function(dst: POpenSSL_C_INT; val: TOpenSSL_C_INT; lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl = Load_CRYPTO_atomic_store_int;
  { No longer needed, so this is a no-op }
...
type
  ...
  function sk_void_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
{# define  CRYPTO_cleanup_all_ex_data() while (0) continue}
  ...
  {# define  CRYPTO_get_locking_callback() (NULL)} {Macro Return Type unknown at line no 314}
  {# define  CRYPTO_set_add_lock_callback(func)}
  {# define  CRYPTO_get_add_lock_callback() (NULL)} {Macro Return Type unknown at line no 316}
...
type
  ...
  {# define  CRYPTO_THREADID_get_callback() (NULL)} {Macro Return Type unknown at line no 336}
...
{# define  CRYPTO_get_id_callback() (NULL)} {Macro Return Type unknown at line no 344}
...
{# define  CRYPTO_get_dynlock_create_callback() (NULL)} {Macro Return Type unknown at line no 351}
{# define  CRYPTO_get_dynlock_lock_callback() (NULL)} {Macro Return Type unknown at line no 352}
{# define  CRYPTO_get_dynlock_destroy_callback() (NULL)} {Macro Return Type unknown at line no 353}
...
type
  ...
  TFuncType001 = function(str: PAnsiChar; len: TOpenSSL_C_SIZET; u: pointer): TOpenSSL_C_INT; cdecl;


      {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function CRYPTO_mem_leaks_cb(cb: TFuncType001; u: pointer): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'CRYPTO_mem_leaks_cb'; deprecated 'Since OpenSSL 3.0';
      {$else}
  {$EXTERNALSYM CRYPTO_mem_leaks_cb}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_CRYPTO_mem_leaks_cb(cb: TFuncType001; u: pointer): TOpenSSL_C_INT; cdecl;

var
  CRYPTO_mem_leaks_cb: function(cb: TFuncType001; u: pointer): TOpenSSL_C_INT; cdecl = Load_CRYPTO_mem_leaks_cb;
      {$endif} {OPENSSL_STATIC_LINK_MODEL}
    {$endif}
    {$ifndef  OPENSSL_NO_STDIO}
      {$ifndef  OPENSSL_NO_DEPRECATED_3_0}
...
const
  ...
  OPENSSL_INIT_ENGINE_ALL_BUILTIN = 0;
  {$ifdef OPENSSL_ENGINE_STUBS}

const
  OPENSSL_INIT_ENGINE_RDRAND = 0;
  OPENSSL_INIT_ENGINE_DYNAMIC = 0;
  OPENSSL_INIT_ENGINE_OPENSSL = 0;
  OPENSSL_INIT_ENGINE_CRYPTODEV = 0;
  OPENSSL_INIT_ENGINE_CAPI = 0;
  OPENSSL_INIT_ENGINE_PADLOCK = 0;
  OPENSSL_INIT_ENGINE_AFALG = 0;
  {$endif}
...
{Error: Line 206: Syntax Error parsing " sk_void_freefunc freefunc = (sk_void_freefunc)freefunc_arg; freefunc((void *)ptr); "
...
function sk_void_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_void_cmpfunc_thunk"');

{Error: Line 206: Syntax Error parsing " int (*realcmp)(const void *const *a, const void *const *b) = (int (*)(const void *const 
*a, const void *const *b))(cmp); const void *const *at = (const void *const *)a; const void *const *bt = (const void *const *)b; 
return realcmp(at, bt); "

 int (*realcmp)(const void *const *a, const void *const *b) = (int (*)(const void *const *a, const void *const *b))(cmp); const 
void *const *at = (const void *const *)a; const void *const *bt = (const void *const *)b; return realcmp(at, bt); }
end;
...
function Load_CRYPTO_atomic_store_int(dst: POpenSSL_C_INT; val: TOpenSSL_C_INT; lock: PCRYPTO_RWLOCK): TOpenSSL_C_INT; cdecl;
begin
  CRYPTO_atomic_store_int := LoadLibCryptoFunction('CRYPTO_atomic_store_int');
  if not assigned(CRYPTO_atomic_store_int) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('CRYPTO_atomic_store_int');
  Result := CRYPTO_atomic_store_int(dst, val, lock);
end;
...
{$endif} { defined(OPENSSL_THREADS)  and  not defined(CRYPTO_TDEBUG)}
function Load_CRYPTO_THREAD_run_once(once: PCRYPTO_ONCE; init: TFuncType002): TOpenSSL_C_INT; cdecl;
begin
...
begin
  ...
  CRYPTO_atomic_store_int := Load_CRYPTO_atomic_store_int;
