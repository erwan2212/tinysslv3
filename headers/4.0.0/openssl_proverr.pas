...
{
  Generated from OpenSSL 4.0.0 Header File proverr.h - Tue 19 May 14:33:05 BST 2026
}
...
const
  ...
  PROV_R_INIT_CALL_OUT_OF_ORDER = 238;
  PROV_R_INSUFFICIENT_DRBG_STRENGTH = 181;
  PROV_R_INVALID_AAD = 108;
  PROV_R_INVALID_AEAD = 231;
  PROV_R_INVALID_CIPHER = 260;
  ...
  PROV_R_INVALID_THREAD_POOL_SIZE = 234;
  ...
  PROV_R_ML_DSA_NO_FORMAT = 245;
  PROV_R_ML_KEM_NO_FORMAT = 246;
  ...
  PROV_R_NO_INSTANCE_ALLOWED = 242;
  PROV_R_NO_KEY_SET = 114;
  PROV_R_NO_PARAMETERS_SET = 177;
  PROV_R_NULL_LENGTH_POINTER = 247;
  PROV_R_NULL_OUTPUT_BUFFER = 248;
  PROV_R_ONESHOT_CALL_OUT_OF_ORDER = 239;
  ...
  PROV_R_PASSWORD_STRENGTH_TOO_WEAK = 254;
  ...
  PROV_R_UNEXPECTED_KEY_PARAMETERS = 249;
  ...
  PROV_R_UNSUPPORTED_SELECTION = 250;
  PROV_R_UPDATE_CALL_OUT_OF_ORDER = 240;
  PROV_R_URI_AUTHORITY_UNSUPPORTED = 223;
  PROV_R_VALUE_ERROR = 138;
  PROV_R_WRONG_CIPHERTEXT_SIZE = 251;
