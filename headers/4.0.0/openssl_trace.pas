...
{
  Generated from OpenSSL 4.0.0 Header File trace.h - Tue 19 May 14:33:34 BST 2026
}
...
const
  ...
  * (This is how the openssl application does it.)
  ...
  OSSL_TRACE_CATEGORY_PKCS5V2 = 6;
  OSSL_TRACE_CATEGORY_PKCS12_KEYGEN = 7;
  OSSL_TRACE_CATEGORY_PKCS12_DECRYPT = 8;
  OSSL_TRACE_CATEGORY_X509V3_POLICY = 9;
  OSSL_TRACE_CATEGORY_BN_CTX = 10;
  OSSL_TRACE_CATEGORY_CMP = 11;
  OSSL_TRACE_CATEGORY_STORE = 12;
  OSSL_TRACE_CATEGORY_DECODER = 13;
  OSSL_TRACE_CATEGORY_ENCODER = 14;
  OSSL_TRACE_CATEGORY_REF_COUNT = 15;
  OSSL_TRACE_CATEGORY_HTTP = 16;
  OSSL_TRACE_CATEGORY_PROVIDER = 17;
  OSSL_TRACE_CATEGORY_QUERY = 18;
  OSSL_TRACE_CATEGORY_NUM = 19;
