...
type
  ...
  function sk_BIO_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
...
var
  ...
  {# define  BIO_get_ex_new_index(l,p,newf,dupf,freef) CRYPTO_get_ex_new_index(CRYPTO_EX_INDEX_BIO, l, p, newf, dupf, freef)} {Macro Return Type unknown at line no 713}
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
...
var
  ...
  function BIO_eof(b: PBIO): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_eof';
  ...
  function Load_BIO_eof(b: PBIO): TOpenSSL_C_INT; cdecl;
...
var
  ...
  BIO_eof: function(b: PBIO): TOpenSSL_C_INT; cdecl = Load_BIO_eof;
...
var
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_set_send_flags(b: PBIO; flags: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_set_send_flags';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_set_send_flags(b: PBIO; flags: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
...
var
  BIO_set_send_flags: function(b: PBIO; flags: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_BIO_set_send_flags;
...
type
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_dump_cb(cb: TFuncType001; u: pointer; s: pointer; len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_dump_cb';
  {$else}
  {$EXTERNALSYM BIO_dump_cb}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_dump_cb(cb: TFuncType001; u: pointer; s: pointer; len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;

var
  BIO_dump_cb: function(cb: TFuncType001; u: pointer; s: pointer; len: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_BIO_dump_cb;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType002 = function(data: pointer; len: TOpenSSL_C_SIZET; u: pointer): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_dump_indent_cb(cb: TFuncType002; u: pointer; s: pointer; len: TOpenSSL_C_INT; indent: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_dump_indent_cb';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_dump_indent_cb(cb: TFuncType002; u: pointer; s: pointer; len: TOpenSSL_C_INT; indent: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
...
var
  BIO_dump_indent_cb: function(cb: TFuncType002; u: pointer; s: pointer; len: TOpenSSL_C_INT; indent: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl = Load_BIO_dump_indent_cb;
...
type
  ...
  TFuncType003 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_write(biom: PBIO_METHOD; write: TFuncType003): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_write';
  {$else}
  {$EXTERNALSYM BIO_meth_set_write}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_write(biom: PBIO_METHOD; write: TFuncType003): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_write: function(biom: PBIO_METHOD; write: TFuncType003): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_write;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType004 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_SIZET; _param4: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_write_ex(biom: PBIO_METHOD; bwrite: TFuncType004): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_write_ex';
  {$else}
  {$EXTERNALSYM BIO_meth_set_write_ex}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_write_ex(biom: PBIO_METHOD; bwrite: TFuncType004): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_write_ex: function(biom: PBIO_METHOD; bwrite: TFuncType004): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_write_ex;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType005 = function(_param1: PBIO; _param2: PBIO_MSG; _param3: TOpenSSL_C_SIZET; _param4: TOpenSSL_C_SIZET; _param5: TOpenSSL_C_UINT64; _param6: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_sendmmsg(biom: PBIO_METHOD; f: TFuncType005): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_sendmmsg';
  {$else}
  {$EXTERNALSYM BIO_meth_set_sendmmsg}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_sendmmsg(biom: PBIO_METHOD; f: TFuncType005): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_sendmmsg: function(biom: PBIO_METHOD; f: TFuncType005): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_sendmmsg;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_read(biom: PBIO_METHOD; read: TFuncType006): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_read';
  {$else}
  {$EXTERNALSYM BIO_meth_set_read}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_read(biom: PBIO_METHOD; read: TFuncType006): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_read: function(biom: PBIO_METHOD; read: TFuncType006): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_read;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_read_ex(biom: PBIO_METHOD; bread: TFuncType007): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_read_ex';
  {$else}
  {$EXTERNALSYM BIO_meth_set_read_ex}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_read_ex(biom: PBIO_METHOD; bread: TFuncType007): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_read_ex: function(biom: PBIO_METHOD; bread: TFuncType007): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_read_ex;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType008 = function(_param1: PBIO; _param2: PBIO_MSG; _param3: TOpenSSL_C_SIZET; _param4: TOpenSSL_C_SIZET; _param5: TOpenSSL_C_UINT64; _param6: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_recvmmsg(biom: PBIO_METHOD; f: TFuncType008): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_recvmmsg';
  {$else}
  {$EXTERNALSYM BIO_meth_set_recvmmsg}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_recvmmsg(biom: PBIO_METHOD; f: TFuncType008): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_recvmmsg: function(biom: PBIO_METHOD; f: TFuncType008): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_recvmmsg;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType009 = function(_param1: PBIO; _param2: PAnsiChar): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_puts(biom: PBIO_METHOD; puts: TFuncType009): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_puts';
  {$else}
  {$EXTERNALSYM BIO_meth_set_puts}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_puts(biom: PBIO_METHOD; puts: TFuncType009): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_puts: function(biom: PBIO_METHOD; puts: TFuncType009): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_puts;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType010 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_gets(biom: PBIO_METHOD; ossl_gets: TFuncType010): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_gets';
  {$else}
  {$EXTERNALSYM BIO_meth_set_gets}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_gets(biom: PBIO_METHOD; ossl_gets: TFuncType010): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_gets: function(biom: PBIO_METHOD; ossl_gets: TFuncType010): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_gets;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType011 = function(_param1: PBIO; _param2: TOpenSSL_C_INT; _param3: TOpenSSL_C_INT; _param4: pointer): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_ctrl(biom: PBIO_METHOD; ctrl: TFuncType011): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_ctrl';
  {$else}
  {$EXTERNALSYM BIO_meth_set_ctrl}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_ctrl(biom: PBIO_METHOD; ctrl: TFuncType011): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_ctrl: function(biom: PBIO_METHOD; ctrl: TFuncType011): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_ctrl;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_create(biom: PBIO_METHOD; create: TFuncType012): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_create';
  {$else}
  {$EXTERNALSYM BIO_meth_set_create}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_create(biom: PBIO_METHOD; create: TFuncType012): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_create: function(biom: PBIO_METHOD; create: TFuncType012): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_create;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType013 = function(_param1: PBIO): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_destroy(biom: PBIO_METHOD; destroy: TFuncType013): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_destroy';
  {$else}
  {$EXTERNALSYM BIO_meth_set_destroy}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_destroy(biom: PBIO_METHOD; destroy: TFuncType013): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_destroy: function(biom: PBIO_METHOD; destroy: TFuncType013): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_destroy;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType014 = function(_param1: PBIO; _param2: TOpenSSL_C_INT; _param3: PBIO_info_cb): TOpenSSL_C_INT; cdecl;


  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_set_callback_ctrl(biom: PBIO_METHOD; callback_ctrl: TFuncType014): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BIO_meth_set_callback_ctrl';
  {$else}
  {$EXTERNALSYM BIO_meth_set_callback_ctrl}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_set_callback_ctrl(biom: PBIO_METHOD; callback_ctrl: TFuncType014): TOpenSSL_C_INT; cdecl;

var
  BIO_meth_set_callback_ctrl: function(biom: PBIO_METHOD; callback_ctrl: TFuncType014): TOpenSSL_C_INT; cdecl = Load_BIO_meth_set_callback_ctrl;
  {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType015 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_write(biom: PBIO_METHOD): TFuncType015; cdecl; external CLibCrypto name 'BIO_meth_get_write'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_write}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_write(biom: PBIO_METHOD): TFuncType015; cdecl;

var
  BIO_meth_get_write: function(biom: PBIO_METHOD): TFuncType015; cdecl = Load_BIO_meth_get_write;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType016 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_SIZET; _param4: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_write_ex(biom: PBIO_METHOD): TFuncType016; cdecl; external CLibCrypto name 'BIO_meth_get_write_ex'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_write_ex}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_write_ex(biom: PBIO_METHOD): TFuncType016; cdecl;

var
  BIO_meth_get_write_ex: function(biom: PBIO_METHOD): TFuncType016; cdecl = Load_BIO_meth_get_write_ex;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType017 = function(_param1: PBIO; _param2: PBIO_MSG; _param3: TOpenSSL_C_SIZET; _param4: TOpenSSL_C_SIZET; _param5: TOpenSSL_C_UINT64; _param6: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_sendmmsg(biom: PBIO_METHOD): TFuncType017; cdecl; external CLibCrypto name 'BIO_meth_get_sendmmsg'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_sendmmsg}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_sendmmsg(biom: PBIO_METHOD): TFuncType017; cdecl;

var
  BIO_meth_get_sendmmsg: function(biom: PBIO_METHOD): TFuncType017; cdecl = Load_BIO_meth_get_sendmmsg;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType018 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_read(biom: PBIO_METHOD): TFuncType018; cdecl; external CLibCrypto name 'BIO_meth_get_read'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_read}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_read(biom: PBIO_METHOD): TFuncType018; cdecl;

var
  BIO_meth_get_read: function(biom: PBIO_METHOD): TFuncType018; cdecl = Load_BIO_meth_get_read;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType019 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_SIZET; _param4: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_read_ex(biom: PBIO_METHOD): TFuncType019; cdecl; external CLibCrypto name 'BIO_meth_get_read_ex'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_read_ex}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_read_ex(biom: PBIO_METHOD): TFuncType019; cdecl;

var
  BIO_meth_get_read_ex: function(biom: PBIO_METHOD): TFuncType019; cdecl = Load_BIO_meth_get_read_ex;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType020 = function(_param1: PBIO; _param2: PBIO_MSG; _param3: TOpenSSL_C_SIZET; _param4: TOpenSSL_C_SIZET; _param5: TOpenSSL_C_UINT64; _param6: POpenSSL_C_SIZET): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_recvmmsg(biom: PBIO_METHOD): TFuncType020; cdecl; external CLibCrypto name 'BIO_meth_get_recvmmsg'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_recvmmsg}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_recvmmsg(biom: PBIO_METHOD): TFuncType020; cdecl;

var
  BIO_meth_get_recvmmsg: function(biom: PBIO_METHOD): TFuncType020; cdecl = Load_BIO_meth_get_recvmmsg;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType021 = function(_param1: PBIO; _param2: PAnsiChar): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_puts(biom: PBIO_METHOD): TFuncType021; cdecl; external CLibCrypto name 'BIO_meth_get_puts'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_puts}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_puts(biom: PBIO_METHOD): TFuncType021; cdecl;

var
  BIO_meth_get_puts: function(biom: PBIO_METHOD): TFuncType021; cdecl = Load_BIO_meth_get_puts;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType022 = function(_param1: PBIO; _param2: PAnsiChar; _param3: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_gets(biom: PBIO_METHOD): TFuncType022; cdecl; external CLibCrypto name 'BIO_meth_get_gets'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_gets}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_gets(biom: PBIO_METHOD): TFuncType022; cdecl;

var
  BIO_meth_get_gets: function(biom: PBIO_METHOD): TFuncType022; cdecl = Load_BIO_meth_get_gets;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType023 = function(_param1: PBIO; _param2: TOpenSSL_C_INT; _param3: TOpenSSL_C_INT; _param4: pointer): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_ctrl(biom: PBIO_METHOD): TFuncType023; cdecl; external CLibCrypto name 'BIO_meth_get_ctrl'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_ctrl}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_ctrl(biom: PBIO_METHOD): TFuncType023; cdecl;

var
  BIO_meth_get_ctrl: function(biom: PBIO_METHOD): TFuncType023; cdecl = Load_BIO_meth_get_ctrl;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType024 = function(_param1: PBIO): TOpenSSL_C_INT; cdecl;
    ...
    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_create(bion: PBIO_METHOD): TFuncType024; cdecl; external CLibCrypto name 'BIO_meth_get_create'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_create}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_create(bion: PBIO_METHOD): TFuncType024; cdecl;

var
  BIO_meth_get_create: function(bion: PBIO_METHOD): TFuncType024; cdecl = Load_BIO_meth_get_create;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType025 = function(_param1: PBIO): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_destroy(biom: PBIO_METHOD): TFuncType025; cdecl; external CLibCrypto name 'BIO_meth_get_destroy'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_destroy}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_destroy(biom: PBIO_METHOD): TFuncType025; cdecl;

var
  BIO_meth_get_destroy: function(biom: PBIO_METHOD): TFuncType025; cdecl = Load_BIO_meth_get_destroy;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
...
type
  ...
  TFuncType026 = function(_param1: PBIO; _param2: TOpenSSL_C_INT; _param3: PBIO_info_cb): TOpenSSL_C_INT; cdecl;


    {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BIO_meth_get_callback_ctrl(biom: PBIO_METHOD): TFuncType026; cdecl; external CLibCrypto name 'BIO_meth_get_callback_ctrl'; deprecated 'Since OpenSSL 3.5';
    {$else}
  {$EXTERNALSYM BIO_meth_get_callback_ctrl}
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BIO_meth_get_callback_ctrl(biom: PBIO_METHOD): TFuncType026; cdecl;

var
  BIO_meth_get_callback_ctrl: function(biom: PBIO_METHOD): TFuncType026; cdecl = Load_BIO_meth_get_callback_ctrl;
    {$endif} {OPENSSL_STATIC_LINK_MODEL}
  {$endif}
{$endif}
...
{Error: Line 350: Syntax Error parsing " sk_BIO_freefunc freefunc = (sk_BIO_freefunc)freefunc_arg; freefunc((BIO *)ptr); "
...
function sk_BIO_cmpfunc_thunk(cmp: TFuncType000; a: pointer; b: pointer): TOpenSSL_C_INT; inline;
begin
  raise Exception.Create('Unable to translate C Function "sk_BIO_cmpfunc_thunk"');

{Error: Line 350: Syntax Error parsing " int (*realcmp)(const BIO *const *a, const BIO *const *b) = (int (*)(const BIO *const *a,
 const BIO *const *b))(cmp); const BIO *const *at = (const BIO *const *)a; const BIO *const *bt = (const BIO *const *)b; return 
realcmp(at, bt); "

 int (*realcmp)(const BIO *const *a, const BIO *const *b) = (int (*)(const BIO *const *a, const BIO *const *b))(cmp); const BIO 
*const *at = (const BIO *const *)a; const BIO *const *bt = (const BIO *const *)b; return realcmp(at, bt); }
end;
...
function Load_BIO_eof(b: PBIO): TOpenSSL_C_INT; cdecl;
begin
  BIO_eof := LoadLibCryptoFunction('BIO_eof');
  if not assigned(BIO_eof) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('BIO_eof');
  Result := BIO_eof(b);
end;
...
function Load_BIO_set_send_flags(b: PBIO; flags: TOpenSSL_C_INT): TOpenSSL_C_INT; cdecl;
begin
  BIO_set_send_flags := LoadLibCryptoFunction('BIO_set_send_flags');
  if not assigned(BIO_set_send_flags) then
    EOpenSSLAPIFunctionNotPresent.RaiseException('BIO_set_send_flags');
  Result := BIO_set_send_flags(b, flags);
end;
...
{$endif} { OPENSSL_NO_SOCK}
  BIO_set_send_flags := Load_BIO_set_send_flags;
